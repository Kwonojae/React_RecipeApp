...
function Veggie() {
  ...
  const getVeggie = async () => {
    const check = localStorage.getItem("veggie"); ////getItem (popular) 키에 데이터 읽기
    /*
    ...
    if (check) {
      setVeggie(JSON.parse(check)); //popular 러를 꺼내옴
      ...
      localStorage.setItem("veggie", JSON.stringify(data.recipes)); //setItem (popular) 키에 데이터 쓰기
